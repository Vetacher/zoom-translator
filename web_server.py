...
def oauth_callback():
    """
    OAuth callback для Zoom
    Сюда приходит код авторизации после того как пользователь разрешил доступ
    """
    ...
    # TODO: Здесь будет логика обмена кода на токен и сохранение в БД
